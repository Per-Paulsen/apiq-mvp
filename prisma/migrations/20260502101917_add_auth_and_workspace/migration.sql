...
-- CreateTable
CREATE TABLE "IpActionLog" (
    "id" TEXT NOT NULL,
    "ip" TEXT NOT NULL,
    "action" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "IpActionLog_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "IpActionLog_ip_action_createdAt_idx" ON "IpActionLog"("ip", "action", "createdAt" DESC);
