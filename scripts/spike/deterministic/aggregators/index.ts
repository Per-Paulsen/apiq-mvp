 ...
 *
 * CLI:
 *   cd scripts/spike && npx tsx deterministic/aggregators/index.ts <spec-name>
 *
...
async function main(): Promise<void> {
  ...
  if (!specName) {
    console.error('Usage: tsx deterministic/aggregators/index.ts <spec-name>');
    console.error('  e.g. tsx deterministic/aggregators/index.ts stripe-full');
    process.exit(1);
  }
