 ...
 *
 * CLI:
 *   npx tsx deterministic/aggregators/privacy-data-class.ts <spec-name>
 */
...
async function main(): Promise<void> {
  ...
  if (!specName) {
    console.error('Usage: tsx deterministic/aggregators/privacy-data-class.ts <spec-name>');
    console.error('  e.g. tsx deterministic/aggregators/privacy-data-class.ts stripe-full');
    process.exit(1);
  }
