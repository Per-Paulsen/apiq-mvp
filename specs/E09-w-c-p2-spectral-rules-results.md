...
2. **F7-codegen-target-Coverage:** 12/25 client-p2-rules mit concrete targets. Soll-Coverage über alle ~170 rules nach Welle D + D2 messen.
...
3. **Custom-functions Count noch sinnvoll?:** 25 functions in 4 files (multi-lang-reserved-keywords + threat-p1 + threat-p2 + client-p2). Welle D wird +30 P3-rules + entsprechende functions adden. Soll Welle D Custom-Functions in einer File konsolidieren oder weiter splitten per lens-priority?
